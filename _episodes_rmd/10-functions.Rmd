...
> ## Tip
>
> `return` statements are not required in R. If one is missing, R will return
> the output of the last call in the function. Best practice in R is not to
> use explicit `return` unless needed. In this chapter, we will explicitly define the
